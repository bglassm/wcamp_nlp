...
def run_full_pipeline(
    ...
    *,
    ...
    for idx, file_path in enumerate(input_files, start=1):
        ...
        logging.info("   [CHECK] facet_top1=%s facet_bucket=%s",
        ...
        if not (has_f1 or has_fb):
            raise RuntimeError("No facet columns in final DataFrame — aborting to prevent empty categories in outputs")
